...
import com.ccy.community.pojo.MessageExample.Criteria;
import com.ccy.community.pojo.MessageExample.Criterion;
...
public class MessageSqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getFromId() != null) {
            sql.SET("from_id = #{record.fromId,jdbcType=INTEGER}");
        }
        
        if (record.getToId() != null) {
            sql.SET("to_id = #{record.toId,jdbcType=INTEGER}");
        }
        
        if (record.getConversationId() != null) {
            sql.SET("conversation_id = #{record.conversationId,jdbcType=VARCHAR}");
        }
